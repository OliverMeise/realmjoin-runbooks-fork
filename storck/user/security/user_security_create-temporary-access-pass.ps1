...
<#
  .SYNOPSIS
  Create an Entra temporary access pass for a user and send to manager.
...
param(
    ...
    [ValidateScript( { Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope Process; Use-RJInterface -Type Graph -Entity Device -DisplayName "Device" } )]
    [String] $Device,
